...
achievement_templates.achievements.level_thirty_witch_hunter = {
	...
	completed = function (statistics_db, stats_id)
		return 30 <= hero_level("witch_hunter")
	end,
	progress = function (statistics_db, stats_id)
...
achievement_templates.achievements.level_thirty_empire_soldier = {
	...
	completed = function (statistics_db, stats_id)
		return 30 <= hero_level("empire_soldier")
	end,
	progress = function (statistics_db, stats_id)
...
achievement_templates.achievements.level_thirty_bright_wizard = {
	...
	completed = function (statistics_db, stats_id)
		return 30 <= hero_level("bright_wizard")
	end,
	progress = function (statistics_db, stats_id)
...
achievement_templates.achievements.level_thirty_dwarf_ranger = {
	...
	completed = function (statistics_db, stats_id)
		return 30 <= hero_level("dwarf_ranger")
	end,
	progress = function (statistics_db, stats_id)
...
achievement_templates.achievements.level_thirty_all = {
	...
	completed = function (statistics_db, stats_id)
		return 30 <= hero_level("wood_elf") and 30 <= hero_level("witch_hunter") and 30 <= hero_level("empire_soldier") and 30 <= hero_level("bright_wizard") and 30 <= hero_level("dwarf_ranger")
	end,
	progress = function (statistics_db, stats_id)
		local count = 0

		if 30 <= hero_level("wood_elf") then
			count = count + 1
		end

		if 30 <= hero_level("witch_hunter") then
			count = count + 1
		end

		if 30 <= hero_level("empire_soldier") then
			count = count + 1
		end

		if 30 <= hero_level("bright_wizard") then
			count = count + 1
		end

		if 30 <= hero_level("dwarf_ranger") then
			count = count + 1
		end
	...
	requirements = function (statistics_db, stats_id)
		...
		return {
			{
				name = "wood_elf_short",
				completed = 30 <= wood_elf
			},
			{
				name = "witch_hunter_short",
				completed = 30 <= witch_hunter
			},
			{
				name = "empire_soldier_short",
				completed = 30 <= empire_soldier
			},
			{
				name = "bright_wizard_short",
				completed = 30 <= bright_wizard
			},
			{
				name = "dwarf_ranger_short",
				completed = 30 <= dwarf_ranger
			}
		}
	end
}
