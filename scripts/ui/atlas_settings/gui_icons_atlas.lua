icons_atlas = {
	...
	weapon_generic_icon_melee_deselected = {
		size = {
			256,
			64
		},
	...
	weapon_generic_icon_range_deselected = {
		size = {
			256,
			64
		},
