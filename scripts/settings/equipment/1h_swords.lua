...
Weapons = Weapons or {}
Weapons.one_handed_swords_template_1 = table.clone(weapon_template)
Weapons.one_handed_swords_template_1_t3_un = table.clone(Weapons.one_handed_swords_template_1)
