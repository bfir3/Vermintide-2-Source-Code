...
Weapons.two_handed_swords_executioner_template_1_t3_un = table.create_copy(Weapons.two_handed_swords_executioner_template_1_t3_un, Weapons.two_handed_swords_executioner_template_1)
