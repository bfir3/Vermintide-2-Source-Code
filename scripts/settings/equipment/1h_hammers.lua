...
Weapons.one_handed_hammer_template_1_t3_un = table.clone(Weapons.one_handed_hammer_template_1)
Weapons.one_handed_hammer_template_1_t3_un.actions.action_inspect.action_inspect_hold.anim_event = "inspect_start_2"
Weapons.one_handed_hammer_template_1_t3_un.actions.action_inspect.action_inspect_hold.anim_end_event = "inspect_end_2"
Weapons.one_handed_hammer_template_2 = table.clone(weapon_template)
Weapons.one_handed_hammer_template_2_t3_un = table.clone(Weapons.one_handed_hammer_template_2)
Weapons.one_handed_hammer_template_2_t3_un.actions.action_inspect.action_inspect_hold.anim_event = "inspect_start_2"
Weapons.one_handed_hammer_template_2_t3_un.actions.action_inspect.action_inspect_hold.anim_end_event = "inspect_end_2"
