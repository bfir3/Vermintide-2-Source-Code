...
local action_data = {
	ground_combat = {
		...
		difficulty_spawn = {
			harder = "skittergate_boss_event_defensive_harder",
			hard = "skittergate_boss_event_defensive_hard",
			normal = "skittergate_boss_event_defensive_normal",
			hardest = "skittergate_boss_event_defensive_hardest",
			easy = "skittergate_boss_event_defensive_easy"
		}
	},
	defensive_idle = {
