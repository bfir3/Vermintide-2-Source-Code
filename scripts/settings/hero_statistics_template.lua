HeroStatisticsTemplate = {
	...
	},
	{
		...
		generate_value = function (params)
			...
			local health = health_extension.get_max_health(health_extension)
			local value = health
	...
	},
	{
		...
		generate_value = function (params)
			...
			local respawn_time = buff_extension.apply_buffs_to_value(buff_extension, base_respawn_time, StatBuffIndex.FASTER_RESPAWN)
	...
	},
	{
		...
		generate_value = function (params)
			...
			local base_cooldown = career_extension.get_max_ability_cooldown(career_extension)
			local modified_cooldown = buff_extension.apply_buffs_to_value(buff_extension, base_cooldown, StatBuffIndex.ACTIVATED_COOLDOWN)
	...
	},
	{
		...
		generate_value = function (params)
			...
			local buff_extension = ScriptUnit.has_extension(player_unit, "buff_system")
			local duration = 100
			local modified_duration = buff_extension.apply_buffs_to_value(buff_extension, duration, StatBuffIndex.FASTER_REVIVE)
	...
	},
	{
		...
		generate_value = function (params)
			...
			local buffed_attack_speed = buff_extension.apply_buffs_to_value(buff_extension, base_attack_speed, StatBuffIndex.ATTACK_SPEED)
	...
	},
	{
		...
		generate_value = function (params)
			...
			local buffed_critical_strike_chance = buff_extension.apply_buffs_to_value(buff_extension, base_critical_strike_chance, StatBuffIndex.CRITICAL_STRIKE_CHANCE)
	...
	},
	{
		...
		generate_value = function (params)
			...
			local critical_strike_boost = buff_extension.apply_buffs_to_value(buff_extension, base_critical_strike_boost, StatBuffIndex.CRITICAL_STRIKE_EFFECTIVENESS)
	...
	},
	{
		...
		generate_value = function (params)
			...
			local headshot_damage = buff_extension.apply_buffs_to_value(buff_extension, base_headshot_damage, StatBuffIndex.HEADSHOT_MULTIPLIER)
	...
	},
	{
		...
		generate_value = function (params)
			...
			local buffed_power_level = buff_extension.apply_buffs_to_value(buff_extension, base_power_level, StatBuffIndex.POWER_LEVEL)
	...
	},
	{
		...
		generate_value = function (params)
			...
			local buff_extension = ScriptUnit.has_extension(player_unit, "buff_system")
			local base_power_level = 100
			local buffed_power_level = buff_extension.apply_buffs_to_value(buff_extension, base_power_level, StatBuffIndex.POWER_LEVEL_SKAVEN)
			local power_level = buffed_power_level - base_power_level
			local value = math.round(power_level)
			local presentation_text = tostring(value) .. "%"
	...
	},
	{
		...
		generate_value = function (params)
			...
			local buff_extension = ScriptUnit.has_extension(player_unit, "buff_system")
			local base_power_level = 100
			local buffed_power_level = buff_extension.apply_buffs_to_value(buff_extension, base_power_level, StatBuffIndex.POWER_LEVEL_CHAOS)
			local power_level = buffed_power_level - base_power_level
			local value = math.round(power_level)
			local presentation_text = tostring(value) .. "%"
	...
	},
	{
		...
		generate_value = function (params)
			...
			local buff_extension = ScriptUnit.has_extension(player_unit, "buff_system")
			local base_power_level = 100
			local buffed_power_level = buff_extension.apply_buffs_to_value(buff_extension, base_power_level, StatBuffIndex.POWER_LEVEL_UNARMOURED)
			local power_level = buffed_power_level - base_power_level
			local value = math.round(power_level)
			local presentation_text = tostring(value) .. "%"
	...
	},
	{
		...
		generate_value = function (params)
			...
			local buff_extension = ScriptUnit.has_extension(player_unit, "buff_system")
			local base_power_level = 100
			local buffed_power_level = buff_extension.apply_buffs_to_value(buff_extension, base_power_level, StatBuffIndex.POWER_LEVEL_ARMOURED)
			local power_level = buffed_power_level - base_power_level
			local value = math.round(power_level)
			local presentation_text = tostring(value) .. "%"
	...
	},
	{
		...
		generate_value = function (params)
			...
			local buff_extension = ScriptUnit.has_extension(player_unit, "buff_system")
			local base_power_level = 100
			local buffed_power_level = buff_extension.apply_buffs_to_value(buff_extension, base_power_level, StatBuffIndex.POWER_LEVEL_LARGE)
			local power_level = buffed_power_level - base_power_level
			local value = math.round(power_level)
			local presentation_text = tostring(value) .. "%"
	...
	},
	{
		...
		generate_value = function (params)
			...
			local buff_extension = ScriptUnit.has_extension(player_unit, "buff_system")
			local base_power_level = 100
			local buffed_power_level = buff_extension.apply_buffs_to_value(buff_extension, base_power_level, StatBuffIndex.POWER_LEVEL_FRENZY)
			local power_level = buffed_power_level - base_power_level
			local value = math.round(power_level)
			local presentation_text = tostring(value) .. "%"
	...
	},
	{
		...
		generate_value = function (params)
			...
			local max_fatigue_points = status_extension.get_max_fatigue_points(status_extension) or 0
	...
	},
	{
		...
		generate_value = function (params)
			...
			local regen_speed = buff_extension.apply_buffs_to_value(buff_extension, base_regen_speed, StatBuffIndex.FATIGUE_REGEN)
	...
	},
	{
		...
		generate_value = function (params)
			...
			local buff_extension = ScriptUnit.has_extension(player_unit, "buff_system")
			local base_arc = 100
			local buffed_arc = buff_extension.apply_buffs_to_value(buff_extension, base_arc, StatBuffIndex.BLOCK_ANGLE)
	...
	},
	{
		...
		generate_value = function (params)
			...
			local buffed_block_cost = buff_extension.apply_buffs_to_value(buff_extension, base_block_cost, StatBuffIndex.BLOCK_COST)
	...
	},
	{
		...
		generate_value = function (params)
			...
			local buffed_stun_duration = buff_extension.apply_buffs_to_value(buff_extension, base_stun_duration, StatBuffIndex.STUN_DURATION)
	...
	},
	{
		...
		generate_value = function (params)
			...
			local buffed_damage_reduction = buff_extension.apply_buffs_to_value(buff_extension, base_damage_reduction, StatBuffIndex.DAMAGE_TAKEN)
	...
	},
	{
		...
		generate_value = function (params)
			...
			local buff_extension = ScriptUnit.has_extension(player_unit, "buff_system")
			local base_damage_reduction = 100
			local buffed_damage_reduction = buff_extension.apply_buffs_to_value(buff_extension, base_damage_reduction, StatBuffIndex.PROTECTION_SKAVEN)
			local damage_reduction = base_damage_reduction - buffed_damage_reduction
			local value = math.round(damage_reduction)
			local presentation_text = tostring(value) .. "%"
	...
	},
	{
		...
		generate_value = function (params)
			...
			local buff_extension = ScriptUnit.has_extension(player_unit, "buff_system")
			local base_damage_reduction = 100
			local buffed_damage_reduction = buff_extension.apply_buffs_to_value(buff_extension, base_damage_reduction, StatBuffIndex.PROTECTION_CHAOS)
			local damage_reduction = base_damage_reduction - buffed_damage_reduction
			local value = math.round(damage_reduction)
			local presentation_text = tostring(value) .. "%"
	...
	},
	{
		...
		generate_value = function (params)
			...
			local buff_extension = ScriptUnit.has_extension(player_unit, "buff_system")
			local base_damage_reduction = 100
			local buffed_damage_reduction = buff_extension.apply_buffs_to_value(buff_extension, base_damage_reduction, StatBuffIndex.PROTECTION_AOE)
			local damage_reduction = base_damage_reduction - buffed_damage_reduction
			local value = math.round(damage_reduction)
			local presentation_text = tostring(value) .. "%"
	...
	},
	{
		...
		generate_value = function (params)
			...
			local buffed_curse_resistance = buff_extension.apply_buffs_to_value(buff_extension, base_curse_resistance, StatBuffIndex.CURSE_PROTECTION)
	...
	},
	{
		...
		generate_value = function (params)
			...
			local buffed_value = buff_extension.apply_buffs_to_value(buff_extension, base_value, StatBuffIndex.TOTAL_AMMO)
	...
	},
	{
		...
		generate_value = function (params)
			...
			local buff_extension = ScriptUnit.has_extension(player_unit, "buff_system")
			local base_value = 100
			local buffed_value = buff_extension.apply_buffs_to_value(buff_extension, base_value, StatBuffIndex.RELOAD_SPEED)
	...
	},
	{
		...
		generate_value = function (params)
			...
			local buffed_value = buff_extension.apply_buffs_to_value(buff_extension, base_value, StatBuffIndex.MAX_OVERCHARGE)
			value = buffed_value
			local presentation_text = tostring(value)
	...
	},
	{
		...
		generate_value = function (params)
			...
			local max_overcharge = overcharge_extension.get_max_value(overcharge_extension)
			local base_value = 100
			local buffed_value = buff_extension.apply_buffs_to_value(buff_extension, base_value, StatBuffIndex.REDUCED_OVERCHARGE)
