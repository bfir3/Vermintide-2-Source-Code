...
CameraStateFollowAttract.init = function (self, camera_state_init_context)
...
CameraStateFollowAttract.on_enter = function (self, unit, input, dt, context, t, previous_state, params)
...
CameraStateFollowAttract.on_exit = function (self, unit, input, dt, context, t, next_state)
	self._follow_unit = nil
end

CameraStateFollowAttract.refresh_follow_unit = function (self, follow_unit, follow_node)
	self._follow_unit = follow_unit
	self._follow_node = follow_node
end

CameraStateFollowAttract.update = function (self, unit, input, dt, context, t)
	local csm = self.csm
