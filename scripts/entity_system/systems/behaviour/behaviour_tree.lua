...
require("scripts/entity_system/systems/behaviour/nodes/bt_allied_follow_action")
...
require("scripts/entity_system/systems/behaviour/nodes/generated/bt_selector_pet_pig")
