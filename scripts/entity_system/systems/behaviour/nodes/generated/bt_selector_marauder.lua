...
BTSelector_marauder.init = function (self, ...)
	BTSelector_marauder.super.init(self, ...)

	self._children = {}
end

BTSelector_marauder.leave = function (self, unit, blackboard, t, reason)
	self.set_running_child(self, unit, blackboard, t, nil, reason)
end

BTSelector_marauder.run = function (self, unit, blackboard, t, dt)
...
BTSelector_marauder.add_child = function (self, node)
