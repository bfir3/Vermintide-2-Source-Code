...
BTSelector_raider_tutorial.leave = function (self, unit, blackboard, t, reason)
	self.set_running_child(self, unit, blackboard, t, nil, reason)
end

BTSelector_raider_tutorial.run = function (self, unit, blackboard, t, dt)
...
BTSelector_raider_tutorial.add_child = function (self, node)
