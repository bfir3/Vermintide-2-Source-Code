...
BTSelector_raider.init = function (self, ...)
	BTSelector_raider.super.init(self, ...)

	self._children = {}
end

BTSelector_raider.leave = function (self, unit, blackboard, t, reason)
	self.set_running_child(self, unit, blackboard, t, nil, reason)
end

BTSelector_raider.run = function (self, unit, blackboard, t, dt)
...
BTSelector_raider.add_child = function (self, node)
