...
BTSelector_chaos_warrior.init = function (self, ...)
	BTSelector_chaos_warrior.super.init(self, ...)

	self._children = {}
end

BTSelector_chaos_warrior.leave = function (self, unit, blackboard, t, reason)
	self.set_running_child(self, unit, blackboard, t, nil, reason)
end

BTSelector_chaos_warrior.run = function (self, unit, blackboard, t, dt)
...
BTSelector_chaos_warrior.add_child = function (self, node)
