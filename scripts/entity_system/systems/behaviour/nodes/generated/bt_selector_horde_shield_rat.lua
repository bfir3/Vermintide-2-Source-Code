...
BTSelector_horde_shield_rat.init = function (self, ...)
	BTSelector_horde_shield_rat.super.init(self, ...)

	self._children = {}
end

BTSelector_horde_shield_rat.leave = function (self, unit, blackboard, t, reason)
	self.set_running_child(self, unit, blackboard, t, nil, reason)
end

BTSelector_horde_shield_rat.run = function (self, unit, blackboard, t, dt)
...
BTSelector_horde_shield_rat.add_child = function (self, node)
