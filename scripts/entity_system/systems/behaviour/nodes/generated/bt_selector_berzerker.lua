...
BTSelector_berzerker.init = function (self, ...)
	BTSelector_berzerker.super.init(self, ...)

	self._children = {}
end

BTSelector_berzerker.leave = function (self, unit, blackboard, t, reason)
	self.set_running_child(self, unit, blackboard, t, nil, reason)
end

BTSelector_berzerker.run = function (self, unit, blackboard, t, dt)
...
BTSelector_berzerker.add_child = function (self, node)
