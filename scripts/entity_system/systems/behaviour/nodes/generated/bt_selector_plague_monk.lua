...
BTSelector_plague_monk.init = function (self, ...)
	BTSelector_plague_monk.super.init(self, ...)

	self._children = {}
end

BTSelector_plague_monk.leave = function (self, unit, blackboard, t, reason)
	self.set_running_child(self, unit, blackboard, t, nil, reason)
end

BTSelector_plague_monk.run = function (self, unit, blackboard, t, dt)
...
BTSelector_plague_monk.add_child = function (self, node)
