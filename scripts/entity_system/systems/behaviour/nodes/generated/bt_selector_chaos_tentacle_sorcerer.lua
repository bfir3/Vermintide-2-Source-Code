...
BTSelector_chaos_tentacle_sorcerer.init = function (self, ...)
	BTSelector_chaos_tentacle_sorcerer.super.init(self, ...)

	self._children = {}
end

BTSelector_chaos_tentacle_sorcerer.leave = function (self, unit, blackboard, t, reason)
	self.set_running_child(self, unit, blackboard, t, nil, reason)
end

BTSelector_chaos_tentacle_sorcerer.run = function (self, unit, blackboard, t, dt)
	...
	local node_spawn_portal = children[8]
	local condition_result = blackboard.ready_to_summon and (blackboard.summoning or Unit.alive(blackboard.target_unit))

	if condition_result then
		self.set_running_child(self, unit, blackboard, t, node_spawn_portal, "aborted")

		local result, evaluate = node_spawn_portal.run(node_spawn_portal, unit, blackboard, t, dt)
...
BTSelector_chaos_tentacle_sorcerer.add_child = function (self, node)
