...
BTSelector_chaos_plague_sorcerer.init = function (self, ...)
	BTSelector_chaos_plague_sorcerer.super.init(self, ...)

	self._children = {}
end

BTSelector_chaos_plague_sorcerer.leave = function (self, unit, blackboard, t, reason)
	self.set_running_child(self, unit, blackboard, t, nil, reason)
end

BTSelector_chaos_plague_sorcerer.run = function (self, unit, blackboard, t, dt)
	...
	local node_spawn_plague_wave = children[8]
	local condition_result = blackboard.ready_to_summon and (blackboard.summoning or Unit.alive(blackboard.target_unit))

	if condition_result then
		self.set_running_child(self, unit, blackboard, t, node_spawn_plague_wave, "aborted")

		local result, evaluate = node_spawn_plague_wave.run(node_spawn_plague_wave, unit, blackboard, t, dt)
...
BTSelector_chaos_plague_sorcerer.add_child = function (self, node)
