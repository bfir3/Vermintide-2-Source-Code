...
DiceRoller.flow_callback_die_collision = function (self, params)
	...
	if 0.1 < Vector3.length(impulse_force) then
...
DiceRoller.simulate_dice_rolls = function (self, success_list)
	...
	for i = 1, num_dice, 1 do
		...
		slot20 = if not math.random(dice_type_success_amounts[dice_type], 6)
...
DiceRoller.run_simulation = function (self, dice_simulation_settings)
	...
	while not finished do
		...
		for i = 1, dice_amount, 1 do
			...
			if Vector3.length(actor_velocity)
			...
			slot22 = if not data.completed_index then
			JUMP TO BLOCK #4
			else
			JUMP TO BLOCK #5
			end
...
DiceRoller.get_dice_result = function (self, unit, dice_type)
	...
	if forward_vec.z == largest_z then
	JUMP TO BLOCK #3
	else
	JUMP TO BLOCK #4
	end
	...
	if broken_heights[dice_type] <= Unit.world_position(unit, 0)
...
DiceRoller.update = function (self, dt)
	...
	slot2 = if not self.rolling then
	JUMP TO BLOCK #1
	else
	JUMP TO BLOCK #2
	end
	...
	for dice_unit, data in pairs(dice_units) do
		...
		if data.completed_index <= lower_index then
		JUMP TO BLOCK #1
		else
		JUMP TO BLOCK #4
		end
		...
		slot26 = if not data.highlighted then
		JUMP TO BLOCK #3
		else
		JUMP TO BLOCK #4
		end
	...
	slot6 = if not self.grace_time then
	JUMP TO BLOCK #6
	else
	JUMP TO BLOCK #7
	end
...
DiceRoller.cleanup_post_roll = function (self)
	...
	for dice_unit, data in pairs(dice_units) do
		...
		slot9 = if not self.remaining_dice[data.dice_type].successes then
		JUMP TO BLOCK #3
		else
		JUMP TO BLOCK #4
		end
		...
		slot11 = if not (num_successes_per_type + 1) then
		JUMP TO BLOCK #6
		else
		JUMP TO BLOCK #7
		end
	...
	slot5 = if self.needs_rerolls then
	JUMP TO BLOCK #3
	else
	JUMP TO BLOCK #5
	end
	...
	if finished_dice ~= num_dice_units_to_remove then
	JUMP TO BLOCK #6
	else
	JUMP TO BLOCK #7
	end
...
if Development.parameter("dice_chance_simulation") then
	...
	dice_configurations[2] = {
		6,
		0,
		1,
		0
	}
	dice_configurations[3] = {
		6,
		1,
		0,
		0
	}
	dice_configurations[4] = {
		6,
		0,
		0,
		1
	}
	dice_configurations[5] = {
		5,
		0,
		2,
		0
	}
	dice_configurations[6] = {
		5,
		2,
		0,
		0
	}
	dice_configurations[7] = {
		5,
		0,
		0,
		2
	}
	dice_configurations[8] = {
		5,
		1,
		1,
		0
	}
	dice_configurations[9] = {
		5,
		0,
		1,
		1
	}
	dice_configurations[10] = {
		5,
		1,
		0,
		1
	}
	dice_configurations[11] = {
		4,
		0,
		3,
		0
	}
	dice_configurations[12] = {
		4,
		1,
		2,
		0
	}
	dice_configurations[13] = {
		4,
		0,
		2,
		1
	}
	dice_configurations[14] = {
		4,
		2,
		1,
		0
	}
	dice_configurations[15] = {
		4,
		0,
		1,
		2
	}
	dice_configurations[16] = {
		4,
		1,
		1,
		1
	}
	dice_configurations[17] = {
		4,
		1,
		0,
		2
	}
	dice_configurations[18] = {
		4,
		2,
		0,
		1
	}
	dice_configurations[19] = {
		3,
		1,
		3,
		0
	}
	dice_configurations[20] = {
		3,
		0,
		3,
		1
	}
	dice_configurations[21] = {
		3,
		2,
		2,
		0
	}
	dice_configurations[22] = {
		3,
		0,
		2,
		2
	}
	dice_configurations[23] = {
		3,
		1,
		2,
		1
	}
	dice_configurations[24] = {
		3,
		2,
		1,
		1
	}
	dice_configurations[25] = {
		3,
		1,
		1,
		2
	}
	dice_configurations[26] = {
		3,
		2,
		0,
		2
	}
	dice_configurations[27] = {
		2,
		2,
		3,
		0
	}
	dice_configurations[28] = {
		2,
		0,
		3,
		2
	}
	dice_configurations[29] = {
		2,
		1,
		3,
		1
	}
	dice_configurations[30] = {
		2,
		2,
		2,
		1
	}
	dice_configurations[31] = {
		2,
		1,
		2,
		2
	}
	dice_configurations[32] = {
		2,
		2,
		1,
		2
	}
	dice_configurations[33] = {
		1,
		2,
		3,
		1
	}
	dice_configurations[34] = {
		1,
		1,
		3,
		2
	}
	dice_configurations[35] = {
		1,
		2,
		2,
		2
	}
	dice_configurations[36] = {
		0,
		2,
		3,
		2
	...
	for i = 1, #dice_configurations, 1 do
		...
		for j = 1, num_simulations, 1 do
			...
			slot24 = if not successes[num_successes] then
			JUMP TO BLOCK #3
			else
			JUMP TO BLOCK #4
			end
